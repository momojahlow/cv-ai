    ...
    <div class="flex flex-col gap-6 max-w-5xl mx-auto bg-white shadow-md mb-6">
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
          <div class="flex space-x-4 justify-between">
            <div class="flex space-x-4">
              ...
              <a :href="`/cv-web/${userInfo.id}/${colorSetting}`" target="_blank" :class="`flex items-center text-${colorSetting} hover:text-pink-600`">
                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="p-6 bg-gray-50 border-t border-gray-200">
          <div class="flex items-center justify-between mb-6">
            ...
            <button @click="toggleSummaryEdit" v-if="userInfo.isAdmin"
              :class="`inline-flex items-center justify-center p-2 rounded-full text-${colorSetting} hover:bg-gray-100`"
            >
        ...
        <div class="p-6 bg-gray-50 border-t border-gray-200">
          <div class="flex items-center justify-between mb-6">
            ...
            <button type="button" @click="showEducationModal = true" v-if="userInfo.isAdmin"
              :class="`inline-flex items-center justify-center p-2 rounded-full text-${colorSetting} hover:bg-gray-100`"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="space-y-6">
            <template v-if="userInfo.educations?.data?.length">
              <div v-for="(education, index) in userInfo.educations.data" :key="index" class="flex">
        ...
        <div class="p-6 bg-gray-50 border-t border-gray-200">
          <div class="flex items-center justify-between mb-6">
            ...
            <button type="button" @click="showExperienceModal = true" v-if="userInfo.isAdmin"
              :class="`inline-flex items-center justify-center p-2 rounded-full text-${colorSetting} hover:bg-gray-100`"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
          ...
          <div class="space-y-6">
            <template v-if="userInfo.experiences?.data?.length">
              <div v-for="(experience, index) in userInfo.experiences.data" :key="index" class="flex gap-2">
                ...
                <div class="flex-1">
                  <div class="flex justify-between">
                    ...
                    <div class="flex space-x-2 p-2">
                      <button type="button" @click="editExperience(experience)" v-if="userInfo.isAdmin" 
                        class="text-[#2b8d96] hover:text-[#1a646b]" 
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
        ...
        <div class="p-6 bg-gray-50 border-t border-gray-200">
          <div class="flex items-center justify-between mb-6">
            ...
            <button @click="showLanguageModal = true" v-if="userInfo.isAdmin"
              :class="`inline-flex items-center justify-center p-2 rounded-full text-${colorSetting} hover:bg-gray-100`"
            >
          ...
          <div class="mt-6 bg-white shadow rounded-lg">
            <!-- Display languages -->
            <div class="space-y-2">
              <template v-if="props.userInfo.languages?.data?.length">
                <div v-for="(lang, index) in props.userInfo.languages.data" :key="index"
                ...
                >
                  ...
                  <div class="flex space-x-2">
                    <button @click="editLanguage(lang)" v-if="userInfo.isAdmin"
                      class="text-[#2b8d96] hover:text-[#1a646b]"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
