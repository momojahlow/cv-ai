            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('curriculum.index')" :active="route().current('curriculum.index')">
                            Mon CV
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('experience.create')" :active="route().current('experience.create')">
                            Ajouter une expérience
                        </ResponsiveNavLink>
                    </div>
